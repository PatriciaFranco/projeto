  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved produto as @produto" do
        post :create, {:produto => invalid_attributes}, valid_session
        expect(assigns(:produto)).to be_a_new(Produto)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested produto" do
        produto = Produto.create! valid_attributes
        put :update, {:id => produto.to_param, :produto => new_attributes}, valid_session
        produto.reload
    ...
    describe "with invalid params" do
      it "assigns the produto as @produto" do
        produto = Produto.create! valid_attributes
        put :update, {:id => produto.to_param, :produto => invalid_attributes}, valid_session
        expect(assigns(:produto)).to eq(produto)
      end
